...
export default function Hero() {
  return (
    <section className="relative min-h-screen pt-20 pb-10 flex items-center justify-center overflow-hidden bg-gradient-to-b from-white via-white to-gray-50">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        ...
        <h1 className="text-5xl md:text-7xl font-bold mb-6 text-black leading-tight animate-slide-in-right" style={{ animationDelay: '0.2s' }}>
          Sua Festa,<br />
        ...
        <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-2xl mx-auto animate-slide-in-left" style={{ animationDelay: '0.4s' }}>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12 animate-slide-in-right" style={{ animationDelay: '0.6s' }}>
          <button className="px-8 py-3 bg-black text-white rounded-lg font-semibold hover:bg-gray-800 transition transform hover:scale-105">
            Solicitar Orçamento
          </button>
          <button className="px-8 py-3 border-2 border-black text-black rounded-lg font-semibold hover:bg-black hover:text-white transition">
            Conhecer Serviços
          </button>
        </div>
        ...
        <div className="flex justify-center gap-8 text-center mb-12 animate-pulse-subtle">
          <div>
            ...
            <p className="text-gray-600 text-sm">Festas Decoradas</p>
          </div>
          ...
          <div className="h-12 w-px bg-gray-300" />
          <div>
            <p className="text-3xl font-bold text-pink-600">8h+</p>
